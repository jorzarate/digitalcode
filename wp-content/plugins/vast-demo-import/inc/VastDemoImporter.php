...
class VastDemoImporter {
	...
	private function final_response() {
		...
		if ( empty( $this->frontend_error_messages ) ) {
			...
			$response['message'] .= sprintf(
				__( '%1$s%3$sThat\'s it, Demo content has been imported successfully.!%4$s%2$sBut it’s not done yet. Let’s tidy up things, please visit <a target=_blank href=https://detheme.helpscoutdocs.com/category/73-vastart-theme>this following link for details </a>..%5$s', 'vdi' ),
