 ...
 * @since 1.0.0
 */
function vastart_google_fonts_list() {
	$fonts = array(
		array(
			'abeezee' => array(
				'family' => 'ABeeZee',
		...
		array(
			'vastart-shadow' => array(
				'family' => 'Vastart Shadow',
				'variants' => array(
					'400',
				),
				'subsets' => array(
 ...
 */
function vastart_enqueue_gooogle_font( $font ) {

	$google_fonts = vastart_google_fonts_list();
	...
	wp_enqueue_style( 'vastart-google-font', $url, false, false, 'all' );
}
